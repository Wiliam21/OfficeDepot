 ...
 * @author apple
 */
public class frmCrearCategoria extends javax.swing.JFrame {
    ...
    public frmCrearCategoria(frmMain main) {
        this.main = main;
        initComponents();
    ...
    private void initComponents() {
        ...
        lblTitulo.setText("Agregar Categoria");
        ...
        getContentPane().add(pnlPrincipal, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 50, 470, 200));
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        ...
        if (!nombre.isEmpty()) {
            try {
                PreparedStatement pst = connection.prepareStatement("INSERT INTO Categoria(Nombre) " + "VALUES (?)");
